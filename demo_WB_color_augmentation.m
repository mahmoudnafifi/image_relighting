...
training_set_dir = fullfile('..','train_t1','input'); % training data path

ground_truth_dir = fullfile('..','train_t1','target'); % ground truth path
...
output_dir = fullfile('..','train_t1', 'input_aug'); % directory to save 
...
outNum = 10; % number of generated images for each original training image. 
...
ground_truth_new_dir = fullfile('..','train_t1', 'target_aug'); 
